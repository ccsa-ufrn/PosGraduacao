...
class ClientStrictoSensu extends ClientAPIsistemas
{
     ...
     *
     * @param string do código da unidade, pode ser adquirido via consulta manual do sigaa
     *        ou através do uso do vetor constante COD_UNIDADE
     */
    function __construct($codUnidade)
    {
    ...
    function equipe()
    {
        $url = ClientAPIsistemas::URL_SERVICE_ROOT['stricto-sensu']."consulta/equipeprograma/".$this->codUnidade;
    ...
    function discentes()
    {
        $url = ClientAPIsistemas::URL_SERVICE_ROOT['stricto-sensu']."consulta/discente/".$this->codUnidade;
        return $this->client->fetch($url)['result'];
    }
    ...
    function projetos()
    {
        $url = ClientAPIsistemas::URL_SERVICE_ROOT['stricto-sensu']."consulta/projeto/".$this->codUnidade;
        return $this->client->fetch($url)['result'];
    }
